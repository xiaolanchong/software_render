...
class SceneRender: public ISceneRender
{
private:
...
public:
	...
	void	Render( IDeviceContext& dc, unsigned int w, unsigned int h, IPropertyMap& propMap ) override;
	void	Tick(IPropertyMap& propMap) override;
