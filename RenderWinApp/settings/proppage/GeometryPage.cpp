...
BOOL	CGeometryPage::OnInitDialog()
{
	...
	CheckDlgButton(IDC_RADIO_GEO_TEXTURE, BST_CHECKED);

	m_stColorDodecahedron.SetColor(RGB(255, 192, 64));
	m_stColorCylinder.SetColor(RGB(0, 192, 0));
	m_stColorTorus.SetColor(RGB(255, 32, 32));
